...
type EmptyIconProps = ViewProps & {
    strokeColor?: string;
    width?: string | number;
    height?: string | number;
};

export function EmptyIcon({ style, strokeColor, width = "24", height = "24" }: EmptyIconProps) {
    const themeColors = useThemeColors();

    // Utilise la couleur fournie, sinon la couleur du thème
